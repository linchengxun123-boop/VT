...
export const PLANS: Record<PlanId, Plan> = {
    ...
    tasks: [
      {
        id: "a-range",
        name: "Range Warmup",
        description: "进入靶场，完成 100 Bots。先站稳再开枪，以准确度为先；时间到即可结束。",
        purpose: "找回手感，建立稳定的开枪节奏。",
        duration_minutes: 5,
      },
      {
        id: "a-crosshair",
        name: "Crosshair Placement Practice",
  ...
  B: {
    ...
    tasks: [
      {
        id: "b-static",
        name: "Static Headshot Warmup",
        description: "在靶场对静止 Bot 单点头部，每次命中后再切换目标，保持匀速。",
  ...
  C: {
    ...
    tasks: [
      {
        id: "c-small",
        name: "Small Target Warmup",
        description: "在靶场拉开与 Bot 的距离，缓慢将准星移动到头部，再开枪。",
      ...
      },
      {
        id: "c-micro",
        name: "微调训练",
        description: "将准星放在 Bot 头部旁，做小幅度修正后单点。拉过时先停下，修正后再开枪。",
        purpose: "练习小幅修枪，减少过度拉枪。",
        duration_minutes: 7,
      },
      {
        id: "c-vandal",
        name: "Vandal One Tap Practice",
        description: "使用 Vandal 逐个单点头部。每枪之间恢复准星，停稳后再射击。",
